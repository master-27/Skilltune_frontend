...
const PracticeSession = () => {
  ...
  return (
    <>
      ...
      <div className='flex justify-center items-center  min-h-screen bg-gradient-to-r bg-gray-300 py-10 px-2'>
          ...
          <div className="mb-4 min-w-max justify-around flex  flex-row">
            <div>
              <label>
                ...
                />
                <span className='mr-1 ml-2'>Beginer</span>
              </label>
            </div>
            <div>
              <label>
                ...
                />
                <span className='ml-2 mr-1 '>Intermediate</span>
              </label>
            </div>
            <div>
              <label>
