  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <h3 className="text-green-500 cursor-pointer" onClick={()=>{navigate("/session" ,{state:{isLoggedin:true, email:email, username:username}})}}>Customize and start practice</h3>
